...
| Source | Owns |
| --- | --- |
| Figma Identity System | Approved visual intent, assets and channel composition |
...
| Cortex-L7 | Positioning, rationale, alternatives, evidence interpretation, plans, history, private context and cross-channel status |
| Portfolio, résumé and project repositories | Detailed professional and technical evidence |
| Live Hub | Final deployed output requiring direct verification |

The checked-out repository must remain understandable and operable without private vault access. Do not copy private strategy, personal records, internal plans or confidential evidence into source documentation.
...
5. Use Cortex-L7 for durable decisions, evidence interpretation, plans, incidents and handoffs.
6. Verify public claims against their actual source repository or approved evidence record.
...
- confidential Atena, client or financial information;
- private Cortex-L7 content or reconstructible private product details.
...
Keep in this repository only current setup, architecture, commands, tests, delivery, security, maintenance and troubleshooting needed to work with the source.

Put in Cortex-L7:

- decisions and alternatives;
- reasoning and consequences;
- audits and historical interpretation;
- claim classification and private evidence context;
- cross-channel status;
- future plans, dependencies and risks;
- incidents and session handoffs.

Do not duplicate an authoritative document in both places.
